...
\begingroup
\thispagestyle{empty}
\AddToShipoutPicture*{\put(0,0){\includegraphics[scale=0.64]{2}}} % Image background
\centering
\vspace*{-1cm}
\par\normalfont\fontsize{35}{35}\sffamily\selectfont
\textbf{Autonomous Racing}\\
{\LARGE F1/10 Autonomous Racing Car}\par % Book title
\vspace*{1cm}
{\Large Nischal K N \quad Paril Jain}\par % Author name
\endgroup
...
\chapterimage{maxresdefault.jpg} % Table of contents heading image
